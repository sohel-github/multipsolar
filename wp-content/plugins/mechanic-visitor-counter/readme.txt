...
fix primary on table
adding view and hits starting number
remove 3 image counter
upgrade options setting
fix privilage access

Plug-in is now compatible upto wordpress version 3.7.1
...
== Upgrade Notice ==
Upgrade your already installed plug-ins to latest version 3.0